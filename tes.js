document.addEventListener("DOMContentLoaded", () => {
    ...
    window.onload = () => {
        ...
        function todoElementMaker(e) {
            ...
            const priorityClass = todoPriorityColor[e.priority] || "low-prior";
        ...
        function renderTodo() {
            ...
            [...todos]
                .sort((a, b) => new Date(a.rDate) - new Date(b.rDate))
                .forEach((e) => {
        ...
        document.querySelector("#todo-content").onclick = (e) => {
